...
set NON_GUI_OPTIONS=-D wxUSE_INTL=OFF^
 ...
 -D wxUSE_DBGHELP=OFF^
 -D wxUSE_INICONF=OFF
REM wxUSE_STOPWATCH=ON (reserved for future updates)
...
set CTRL_OPTIONS=-D wxUSE_ACTIVITYINDICATOR=OFF^
...
REM wxUSE_MARKUP=ON (reserved for future updates)
REM wxUSE_COLLPANE=ON (reserved for future updates)

set DLG_OPTIONS=-D wxUSE_COLOURDLG=OFF^
...
REM wxUSE_ABOUTDLG=ON (reserved for future updates)

set MISC_GUI_OPTIONS=-D wxUSE_SPLINES=OFF^
...
REM wxUSE_VALIDATORS=ON (reserved for future updates)
...
if /I "%~1"=="NoTest" (
    ...
    set CTRL_OPTIONS=%CTRL_OPTIONS% -D wxUSE_COMBOBOX=OFF
)

set IMG_OPTIONS=-D wxUSE_GIF=OFF^
 -D wxUSE_PCX=OFF^
 -D wxUSE_TGA=OFF^
 -D wxUSE_IFF=OFF^
 -D wxUSE_PNM=OFF^
