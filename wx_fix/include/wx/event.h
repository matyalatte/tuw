...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxIdleEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxThreadEvent);
};
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxCommandEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxNotifyEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxScrollEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxScrollWinEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_REMOVABLE(wxMouseEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxSetCursorEvent);
};
...
protected:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxGestureEvent);
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxPanGestureEvent);
};
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxZoomGestureEvent);
};
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxRotateGestureEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxTwoFingerTapEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxLongPressEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxPressAndTapEvent);
};
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_REMOVABLE(wxKeyEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxSizeEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxMoveEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxPaintEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxNcPaintEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxEraseEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxFocusEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxChildFocusEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxActivateEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxInitDialogEvent);
};
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxMenuEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxCloseEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxShowEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxIconizeEvent);
};
/*
 wxEVT_MAXIMIZE
 */
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxMaximizeEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxFullScreenEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxJoystickEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxDropFilesEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxUpdateUIEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxSysColourChangedEvent);
};
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxMouseCaptureChangedEvent);
};
...
public:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxMouseCaptureLostEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxDisplayChangedEvent);
};
...
private:
    ...
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxDPIChangedEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxPaletteChangedEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxQueryNewPaletteEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxNavigationKeyEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxWindowCreateEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_DEF_COPY_REMOVABLE(wxWindowDestroyEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxHelpEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxClipboardTextEvent);
};
...
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN_REMOVABLE(wxContextMenuEvent);
};
