...
// ----------------------------------------------------------------------------
    ...
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxIdleEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxThreadEvent, wxEvent);
#endif // wxUSE_BASE

#if wxUSE_GUI
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxCommandEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxNotifyEvent, wxCommandEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxScrollEvent, wxCommandEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxScrollWinEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxMouseEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxKeyEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxSizeEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxPaintEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxNcPaintEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxEraseEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxMoveEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxFocusEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxChildFocusEvent, wxCommandEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxCloseEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxShowEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxMaximizeEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxIconizeEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxFullScreenEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxMenuEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxJoystickEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxDropFilesEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxActivateEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxInitDialogEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxSetCursorEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxSysColourChangedEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxDisplayChangedEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxDPIChangedEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxUpdateUIEvent, wxCommandEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxNavigationKeyEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxPaletteChangedEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxQueryNewPaletteEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxWindowCreateEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxWindowDestroyEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxHelpEvent, wxCommandEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxContextMenuEvent, wxCommandEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxMouseCaptureChangedEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxMouseCaptureLostEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxClipboardTextEvent, wxCommandEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxGestureEvent, wxEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxPanGestureEvent, wxGestureEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxZoomGestureEvent, wxGestureEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxRotateGestureEvent, wxGestureEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxTwoFingerTapEvent, wxGestureEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxLongPressEvent, wxGestureEvent);
    wxIMPLEMENT_DYNAMIC_CLASS_REMOVABLE(wxPressAndTapEvent, wxGestureEvent);
#endif // wxUSE_GUI
